...
namespace WinUsb
{
    sealed internal partial class WinUsbDevice
    {
        ...
        internal DevInfo myDevInfo = new();
        ...
        internal bool Do_Control_Read_Transfer(ref byte[] dataStage)
        {
            ...
            try
            {
                ...
                success = NativeMethods.WinUsb_ControlTransfer(myDevInfo.winUsbHandle, setupPacket, dataStage, Convert.ToUInt16(dataStage.Length), ref bytesReturned, IntPtr.Zero);
                return success;
        ...
        {
            uint bytesReturned = 0;
            ushort index = Convert.ToUInt16(0);
            NativeMethods.WINUSB_SETUP_PACKET setupPacket;
            bool success;
        ...
        ///  
        internal void ReadViaBulkTransfer(byte pipeID, uint bytesToRead, ref byte[] buffer, ref uint bytesRead, ref bool success)
        {
            try
            {
                // ***
        ...
        ///  <summary>
        ///  Sets pipe policy.
        ///  Used when the value parameter is a uint (PIPE_TRANSFER_TIMEOUT only).
        ///  </summary>
        ///  
        ///  <param name="pipeId"> Pipe to set a policy for. </param>
        ///  <param name="policyType"> POLICY_TYPE member. </param>
        ...
        private bool UsbEndpointDirectionIn(Int32 addr)
        {
            bool directionIn;
        ...
        private bool UsbEndpointDirectionOut(Int32 addr)
        {
            bool directionOut;
